...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    bot.command(/\/gimg\s.+/, (ctx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield promises_1.default.writeFile(path_1.default.join(__dirname, `image/image_${ctx.message.from_id}.png`), imageBuffer);
            const reqVkServer = yield (0, axios_1.default)({
                method: "post",
                url: upload_url,
                headers: { "Content-Type": "multipart/form-data" },
                data: {
                    photo: (0, fs_1.createReadStream)(path_1.default.join(__dirname, `image/image_${ctx.message.from_id}.png`)),
                },
            });
